...
@author: nsahu
"""
from CS50423 import is_legal_region
...
"""
# x= is_legal_region([[1, 1, 0, 1], [1, 1, 0, 0]], [None, 0, None])
x= is_legal_region([[1,1,1,1], ['x',1,'x',0], [1,0,0,0], [1,'x',0,'x']], [None, 1, 0,None])

print(x)

root = kmap([[1,1,1,1], ['x',1,'x',0], [1,0,0,0], [1,'x',0,'x']])
# root = kmap([[1, 1, 0, 1], [1, 1, 0, 1]])
# root.draw_region(0,1,1,2,'blue')
root.draw_region(x[0][0],x[0][1],x[1][0],x[1][1],'green')
root.mainloop()
